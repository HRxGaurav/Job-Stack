        ...
        <div className={style.job_grid}>
          <div className={style.card_detail}>
            ...
            <div className={style.job_feed}>
              <div className={style.jobPay}>{`₹ ${min_ctc} - ${max_ctc} `}</div>
              <div className={style.jobPay}>{location}</div>
            </div>
            <div className={style.job_types}>
              <div className={style.job_type}>{`Location ${experienceRequired}`}</div>
              <div className={style.job_type}>{job_type}  {id}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={style.card_right}>
        <div className={style.card_skill}>
          <div className={style.job_details}>
            {applying ? (
              <button className={style.view_job} disabled>Applying...</button>
            ) : (
              <button className={style.view_job} onClick={handleApplyJob}>Apply using {requiredRupees} Rupees</button>
            )}
          </div>
        </div>
      </div>
